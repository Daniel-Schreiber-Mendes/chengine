...
void window_import()
{
    checs_command_register(<C:WindowCloseCommand>);
    checs_command_register(<C:FramebufferSizeCommand>);
    checs_command_register(<C:KeyCommand>);
    checs_command_register(<C:MouseButtonCommand>);
    checs_command_register(<C:ScrollCommand>);
}

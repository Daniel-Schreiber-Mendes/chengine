...
void render_system_imm_rectangle_draw(vec4 const color, vec3 const pos, vec2 const size)
{
...
void render_system_imm_text_draw(vec4 const color, vec2 const pos, Text const *const t)
{
	vao_bind(&text_vao);
...
void render_system_imm_font_load(Font *const font)
{

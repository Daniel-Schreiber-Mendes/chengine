...
.Ltext0:
	.local	size
	.comm	size,4,2
	.local	videoModeCount
	.comm	videoModeCount,4,4
	.local	modes
	.comm	modes,8,8
	.local	mode
	.comm	mode,24,16
	...
	.section	.rodata
.LC0:
	.string	"window/window.c"
.LC1:
	.string	"glfwInit()"
.LC2:
	.string	"Failed to construct window"
.LC3:
	.string	"glewInit() == GLEW_OK"
	.text
	.globl	window_init
	.type	window_init, @function
window_init:
.LFB894:
	.file 1 "window/window.c"
	.loc 1 13 0
	.cfi_startproc
	pushq	%rbp
...
1:	call	*mcount@GOTPCREL(%rip)
	...
	leaq	__PRETTY_FUNCTION__.24534(%rip), %rcx
	movl	$14, %edx
	leaq	.LC0(%rip), %rsi
	leaq	.LC1(%rip), %rdi
...
.L2:
	...
	movq	%rax, monitor(%rip)
	.loc 1 17 0
	movq	monitor(%rip), %rax
	leaq	videoModeCount(%rip), %rsi
	movq	%rax, %rdi
	call	glfwGetVideoModes@PLT
	movq	%rax, modes(%rip)
	.loc 1 18 0
	movq	modes(%rip), %rcx
	movl	videoModeCount(%rip), %eax
	movslq	%eax, %rdx
	movq	%rdx, %rax
	addq	%rax, %rax
	addq	%rdx, %rax
	...
	.loc 1 23 0
	movl	12+mode(%rip), %eax
	movl	%eax, %esi
	movl	$135170, %edi
	call	glfwWindowHint@PLT
	.loc 1 24 0
	movl	16+mode(%rip), %eax
	movl	%eax, %esi
	movl	$135171, %edi
	call	glfwWindowHint@PLT
	.loc 1 25 0
	movl	20+mode(%rip), %eax
	movl	%eax, %esi
	movl	$135183, %edi
	call	glfwWindowHint@PLT
	.loc 1 27 0
	movq	monitor(%rip), %rcx
	movzwl	2+size(%rip), %eax
	movzwl	%ax, %esi
	movzwl	size(%rip), %eax
	movzwl	%ax, %eax
	movq	-8(%rbp), %rdx
...
.L3:
	.loc 1 34 0
	movq	window(%rip), %rax
	leaq	framebuffer_size_callback(%rip), %rsi
	movq	%rax, %rdi
...
.L5:
	...
	.cfi_endproc
.LFE894:
	.size	window_init, .-window_init
	.globl	window_terminate
	.type	window_terminate, @function
window_terminate:
.LFB895:
	.loc 1 42 0
	.cfi_startproc
...
1:	call	*mcount@GOTPCREL(%rip)
	...
	.cfi_endproc
.LFE895:
	.size	window_terminate, .-window_terminate
	.globl	framebuffer_size_callback
	.type	framebuffer_size_callback, @function
...
1:	call	*mcount@GOTPCREL(%rip)
	...
	.cfi_endproc
.LFE896:
	.size	framebuffer_size_callback, .-framebuffer_size_callback
	.section	.rodata
	.align 8
	.type	__PRETTY_FUNCTION__.24534, @object
	.size	__PRETTY_FUNCTION__.24534, 12
__PRETTY_FUNCTION__.24534:
	.string	"window_init"
	.text
.Letext0:
	...
	.file 12 "window/../utility/utility.h"
	.file 13 "/usr/include/GLFW/glfw3.h"
	.file 14 "/usr/include/GL/freeglut_std.h"
	.file 15 "window/window.h"
...
.Ldebug_info0:
	...
	.uleb128 0x9
	.byte	0x3
	.quad	__PRETTY_FUNCTION__.24534
	.byte	0
	.uleb128 0xc
	.long	0xbb
	.long	0x18214
...
.LASF5571:
	.string	"framebuffer_size_callback"
.LASF434:
